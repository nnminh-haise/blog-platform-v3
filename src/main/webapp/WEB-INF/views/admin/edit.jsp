                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form class="forms-sample" enctype="multipart/form-data" method="post" action="admin/edit/${slug}.htm" modelAttribute="updateBlogDto">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:input path="subTitle" type="text" name="subtitle" class="form-control"   placeholder="Subtitle" />
                                    </div>
                                    <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="form-check-input" name="cates" value="${entry.key}"
                                                               <c:if test="${fn:contains(categorySlugs, entry.key)}">checked="checked"</c:if>>
                                                            ${entry.value}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" name ="file" disabled="true" value="${blogAttachment}" placeholder="Upload Image" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <form:radiobutton path="isPopular" value="true" class="form-check-input"/> True <i class="input-helper"></i>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-5">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <form:radiobutton path="isPopular" value="false" class="form-check-input"/> False <i class="input-helper"></i>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <input type="hidden" name="categorySlugs">
