                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form class="forms-sample" id="main-container" enctype="multipart/form-data" method="post" modelAttribute="updateBlogDto" action="${pageContext.request.contextPath}/admin/edit/${slug}.htm">
