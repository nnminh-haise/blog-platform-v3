                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form class="forms-sample" enctype="multipart/form-data" method="post" action="admin/test/insert.htm" modelAttribute="createBlogDto">
...
<%--                                        <input type="file" path="attachment" name="attachment" class="file-upload-default" />--%>
<%--                                        <div class="input-group col-xs-12">--%>
<%--                                            &lt;%&ndash;                      <input type="text" class="form-control file-upload-info" name ="attachment" disabled="true" placeholder="Upload Image" />&ndash;%&gt;--%>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <form:radiobutton path ="is_popular" type="radio" class="form-check-input" name="is_popular" id="membershipRadios1" value="true" checked=""/> True <i class="input-helper"></i></label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-5">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <form:radiobutton path ="is_popular" type="radio" class="form-check-input" name="is_popular" id="membershipRadios2" value="false"/> False <i class="input-helper"></i></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
