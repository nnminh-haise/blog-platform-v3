    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="admin/categories/index.htm">
                    ...
                    <div class="col-lg-12 stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="admin/categories/editor/${id}.htm?pageCategory=${pageCategory}" method="POST" modelAttribute="createCategoryDto">
                                                ...
                                                <td style="width: 20%;">
                                                    <c:choose>
                                                        <c:when test="${category.id eq id}">
                                                            ...
                                                            <a href="admin/categories/delete/${category.id}.htm?pageCategory=${pageCategory}" >
                                                                <button type="button" class="btn btn-gradient-danger btn-fw">Delete</button>
                                                            </a>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <!-- Nếu không, hiển thị nút "Edit" và "Delete" -->
                                                            <a href="admin/categories/editor/${category.id}.htm?pageCategory=${pageCategory}" >
