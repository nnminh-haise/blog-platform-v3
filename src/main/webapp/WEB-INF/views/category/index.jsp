                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <c:forEach var="category" items="${categories}" varStatus="loop">
                                        ...
                                        <tr class="${rowClass}">
                                            ...
                                            <td style="width: 20%;">
                                                ...
                                                <a href="admin/categories/delete/${category.id}.htm?pageCategory=${pageCategory}" onclick="return confirm('are you sure')">
                                ...
                                <div style="margin:30px; text-align : right">
                                    <a href="admin/categories/index.htm?pageCategory=${pageCategory-1}">
